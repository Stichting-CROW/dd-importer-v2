...
CREATE ROLE dashboarddeelmobiliteit;
...
CREATE INDEX idx_non_operational_event_start_end
...
INSERT INTO public.vehicle_type (vehicle_type_id, external_vehicle_type_id, form_factor, propulsion_type, max_permitted_speed, system_id, name, icon_url) VALUES (20, 'DEFAULT_ELECTRIC_CAR', 'car', 'electric', NULL, NULL, 'default electric car', NULL);
INSERT INTO public.vehicle_type (vehicle_type_id, external_vehicle_type_id, form_factor, propulsion_type, max_permitted_speed, system_id, name, icon_url) VALUES (21, ' DEFAULT_COMBUSTION_CAR', 'car', 'combustion', NULL, NULL, 'default combustion car', NULL);
INSERT INTO public.vehicle_type (vehicle_type_id, external_vehicle_type_id, form_factor, propulsion_type, max_permitted_speed, system_id, name, icon_url) VALUES (22, 'DEFAULT_CAR', 'car', NULL, NULL, NULL, 'default car', NULL);
